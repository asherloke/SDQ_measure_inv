...
In wave 5, there are only SDQ scores from parents and teachers.
...
#join them
w5_parent_teacher <- union(data_w5_parent, data_w5_teacher)
...
In wave 7, there are only SDQ scores from parents and cohort members (self-report).
...
#join them
w7_parent_CM <- union(data_w7_parent, data_w7_CM)
